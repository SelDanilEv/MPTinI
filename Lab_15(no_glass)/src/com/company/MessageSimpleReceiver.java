...
public class MessageSimpleReceiver implements MessageListener {

    ConnectionFactory factory = new ConnectionFactory();
    JMSConsumer consumerQ;
    JMSConsumer consumerT;

    MessageSimpleReceiver() {
    ...
    public void onMessage(Message message) {
        try {
            ...
            System.out.println("Message filter: " + message.getStringProperty("Filter"));
